    ...
    <div className="friend-apply--list__item">
      <div className="item-left">
        ...
        <div className="item-left__info">
          <span className="item-left__info--name">
            {userName}
          </span>
          <span className="item-left__info--dep">
            {depName}
          </span>
        </div>
      </div>
      <div className="item-right">
        <span className="item-right__approve" onClick={() => handleApprove() }></span>
        <span className="item-right__refuse" onClick={() => handleRefuse() }></span>
      </div>
    </div>
  );
};
